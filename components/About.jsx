...
function About() {
  return (
    ...
    >
      <div className='sm:grid items-center sm:grid-cols-2 p-8 md:p-16 shadow-accent rounded-[4px] bg-[#174750]'>
        <div className='flex flex-col gap-8 text-left'>
          ...
          <p className='text-lg text-white max-w-lg'>
            ...
            MEV, MEV Bot is the Key to unlocking the full power od decentralized
            finance (Defi)
          </p>
